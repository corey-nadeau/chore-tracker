...
function ChildDashboard() {
  ...
  const profilePictureOptions = [
    ...
    'ðŸ¶', 'ðŸ±', 'ðŸ°', 'ðŸ¼', 'ðŸ¦„',
    // 10 Face emojis  
    'ðŸ˜€', 'ðŸ˜ƒ', 'ðŸ˜„', 'ðŸ˜', 'ðŸ˜†', 'ðŸ˜Š', 'ðŸ˜‡', 'ðŸ™‚', 'ðŸ˜‰', 'ðŸ˜Ž',
    // 5 Sports emojis
    'âš½', 'ðŸ€', 'ðŸŽ¾', 'ðŸˆ', 'âš¾'
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 to-secondary-50 p-4 pb-8">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="text-center mb-8">
          <div className="text-massive mb-6 animate-bounce-slow">🎯</div>
          ...
          <div className="text-center">
            ...
            <div className="bg-blue-50 rounded-xl p-6 mb-6 border-2 border-blue-200">
              <div className="flex items-center justify-center space-x-3 mb-3">
                <div className="text-3xl">Ã°Å¸ÂªÂ£</div>
            ...
            {currentGoals.length > 0 ? (
              <div className="space-y-4">
                <h3 className="text-2xl font-bold text-purple-800 mb-4">Ã°Å¸Å½Â¯ Your Goals</h3>
                    ...
                    >
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <div className="flex items-center space-x-2">
                          {isCompleted && (
                            <div className="text-2xl animate-bounce">Ã°Å¸Å½â€°</div>
                          )}
                          <div className="text-purple-400">Ã°Å¸â€˜â€  Click to view</div>
                        </div>
                      </div>
                        ...
                        <div className="space-y-3">
                          ...
                          {isCompleted ? (
                            <div className="bg-green-100 rounded-lg p-4 text-center border-2 border-green-300">
                              <div className="text-4xl mb-2 animate-bounce">Ã°Å¸Å½â€°</div>
                              <p className="text-green-800 font-bold text-xl mb-2">
                                Ã°Å¸Å½â€° CONGRATULATIONS! Ã°Å¸Å½â€°
                              </p>
                              ...
                              <div className="mt-3 text-green-500 text-sm">
                                Ã¢Å“Â¨ Amazing work! You did it! Ã¢Å“Â¨
                              </div>
                            </div>
                          ) : (
                            <p className="text-purple-600 text-center">
                              Ã°Å¸â€™Âª ${((goal.targetAmount || 0) - (goal.savedAmount || 0)).toFixed(2)} left to reach your goal!
                            </p>
                          )}
                        </div>
                      ) : (
                        <div className="bg-yellow-100 rounded-lg p-4 text-center">
                          <div className="text-3xl mb-2">Ã°Å¸Å½Â</div>
              ...
              <div className="bg-gray-50 rounded-xl p-6 text-center">
                <div className="text-4xl mb-3">Ã°Å¸ËœÅ </div>
                    ...
                    <div>
                      ...
                      {currentGoals.filter(goal => goal.isMonetary && getGoalProgress(goal) >= 100).length > 0 && (
                        <div className="mt-4 p-3 bg-green-50 rounded-lg border border-green-200">
                          <p className="text-green-700 text-sm font-medium mb-2">Ã¢Å“â€¦ Completed Goals:</p>
                          {currentGoals.filter(goal => goal.isMonetary && getGoalProgress(goal) >= 100).map(goal => (
                            <p key={goal.id} className="text-green-600 text-sm">
                              Ã°Å¸Å½â€° {goal.title} - Goal reached!
                            </p>
                          ))}
                        </div>
                      )}
        ...
        <div className="mb-8">
          ...
          {assignedChores.length === 0 ? (
            <div className="bg-white rounded-3xl shadow-lg p-8 text-center">
              ...
              <p className="text-gray-600">No chores assigned right now. Great job! Ã°Å¸Å’Å¸</p>
            </div>
          ) : (
                ...
                <div key={chore.id} className="bg-white rounded-3xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-200">
                  ...
                  {chore.rejectedAt && (
                    <div className="bg-orange-100 border-2 border-orange-300 rounded-lg p-3 mb-4 text-center">
                      <div className="text-2xl mb-2">Ã°Å¸â€â€ž</div>
                  ...
                  <div className="text-center mb-4">
                    ...
                    <div className="flex justify-center items-center space-x-4 text-sm text-gray-500 mb-4">
                      <span>Ã°Å¸â€œÂ {chore.location}</span>
                      <span>Ã°Å¸â€™Â° ${chore.reward.toFixed(2)}</span>
                      {chore.type && <span>Ã°Å¸ÂÂ  {chore.type}</span>}
                    </div>
                    ...
                    {chore.dueDate && (
                      <p className="text-sm text-orange-600 mb-4">
                        Ã°Å¸â€œâ€¦ Due: {new Date(chore.dueDate.toDate()).toLocaleDateString()}
                      </p>
                    )}
                  </div>
                  ...
                  >
                    <span className="relative z-10">Ã¢Å“â€¦ Done!</span>
            ...
            <div className="p-6 md:p-8">
              ...
              <div className="flex items-center justify-between mb-6 sticky top-0 bg-white z-10 pb-4 border-b border-gray-200">
                <div className="flex items-center space-x-3">
                  ...
                  <div className="text-3xl">Ã°Å¸Å½Â¯</div>
                  <div>
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex-1">
                              ...
                              <div className="flex items-center space-x-4 text-sm text-gray-500">
                                <span>Ã°Å¸â€™Â° ${chore.reward.toFixed(2)}</span>
                                <span>Ã°Å¸â€œâ€¦ {new Date(chore.rewardAppliedAt?.toDate() || chore.approvedAt?.toDate() || chore.createdAt).toLocaleDateString()}</span>
                                <span>
                                  Ã°Å¸Å½Â¯ {isAssignedToThisGoal 
                                    ? 'This goal' 
                            ...
                            <div className="ml-4">
                              ...
                              >
                                <option value="">Savings Bucket Ã°Å¸ÂªÂ£</option>
                                {currentGoals.filter(g => g.status === 'active' && g.isMonetary).map(goal => {
                                  ...
                                  return (
                                    <option key={goal.id} value={goal.id} disabled={isCompleted}>
                                      {goal.title} {isCompleted ? '(Completed Ã¢Å“â€¦)' : ''}
                                    </option>
                                  );
                                })}
                              </select>
          ...
          >
            <div className="p-6 flex-shrink-0">
              ...
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center space-x-3">
                  <div className="text-3xl">Ã¢Å¡â„¢Ã¯Â¸Â</div>
              ...
              <div className="text-center mb-6 p-4 bg-gray-50 rounded-xl">
                <div className="text-6xl mb-3">{child.profilePicture || 'Ã°Å¸ËœÅ '}</div>
            ...
            <div className="p-6 flex-shrink-0 border-t border-gray-200">
              <div className="text-center">
                <p className="text-gray-600 text-sm">
                  Choose from animals, faces, or fun characters! Ã°Å¸Å½â€°
                </p>
              </div>
            </div>
          </div>
...
function getChoreIcon(category) {
  const icons = {
    cleaning: 'Ã°Å¸Â§Â½',
    dishes: 'Ã°Å¸ÂÂ½Ã¯Â¸Â',
    laundry: 'Ã°Å¸â€˜â€¢',
    outdoor: 'Ã°Å¸Å’Â±',
    pets: 'Ã°Å¸Ââ€¢',
    organization: 'Ã°Å¸â€œÂ¦',
    homework: 'Ã°Å¸â€œÅ¡',
    other: 'Ã¢Â­Â'
  };
  return icons[category] || 'Ã¢Â­Â';
}
